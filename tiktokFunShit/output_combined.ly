...
\markup{
"Remove any two loops (except speech) from the system, one at a time"
}
\markup {
  \general-align #Y #DOWN {
    \epsfile #X #20 #"res.eps"
    \epsfile #Y #20 #"res.eps"
  }
}
...
\markup{
	\column{
"Remove remaining loops from the system one at a time,"
"leaving speech until last"
	}
}
